### Requirements ###
    ...
    It is recommended to run Collab on LAMP (Linux, Apache, MySQL, PHP) servers.
...
### Installation instructions ###
    ...
    1. Unpack the Collab archive on your computer.
...
### License conditions ###
    ...
    Collab is free software under the terms and conditions of the
